...
public class MainService extends Service {
    ...
    public void createNotification(String content) {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(this, serviceID, notificationIntent, PendingIntent.FLAG_IMMUTABLE);

        NotificationCompat.Action action = new NotificationCompat.Action.Builder(0, "Exit", pendingIntent).build();
        Notification notification = new NotificationCompat.Builder(this, String.valueOf(serviceID))
                .setContentTitle("Seledroid Chromium")
